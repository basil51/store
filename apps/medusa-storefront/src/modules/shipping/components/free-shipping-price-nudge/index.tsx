          ...
          <div>
            {price.target_reached ? (
              <div className="flex items-center gap-1.5">
                ...
                {t("shippingFreeShippingUnlocked")}
              </div>
            ) : (
              t("shippingUnlockFreeShipping")
            )}
          </div>
...
function FreeShippingPopup({
  ...
  return (
    <div
      className={clx(
        "fixed bottom-5 flex flex-col items-end gap-2 transition-all duration-500 ease-in-out z-10",
        {

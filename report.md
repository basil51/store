...
| Phases 12+ | i18n at scale, performance, etc. | Phase 12 is started with a first catalog-translation tooling slice |
...
1. **Continue Phase 12** from the new collection-translation tooling baseline with the next translated-catalog or locale-driven content slice.
